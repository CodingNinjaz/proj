...
<ul id="main-menu" class="" >
	...
	<li class="" id="hassubopen"><a href="#" onclick="memberExpand(1)"><i class="entypo-users"></i><span>Members</span></a>
		<ul id="memExpand">
			<li class="active"><a href="table_view.php"><span>View User</span></a></li>
			<!-- <li class="active">
				<a href="view_tra.php"><span>Edit Trainers</span></a></li> -->
			<li><a href="table_tra_view.php"><span>View Trainers</span></a></li>
		</ul>
	</li>
